<template>
    <section class="text-white mt-20" id="contact">
        <h2 class="text-4xl font-bold text-white text-left mb-4 px-4 xl:pl-16">Mes Contacts</h2>
            ...
            <div>
                <div class="col-lg-4 col-md-4 mb-lg-0 mt-5">
                    ...
                    <div class="flex mb-10 items-center">
                        ...
                        <div class="ml-5 text-white">
                            <h4>LinkedIn</h4>
                            <p>www.linkedin.com/in/eileena-patamia</p>
                        </div>
                    </div>
                    <div class="flex mb-10 items-center">
                        <div class="p-2"
                        ...
                        <div class="ml-5 text-white">
                            <h4>Github</h4>
                            <p>https://github.com/Kyrudia?tab=repositories</p>
                        </div>
                    </div>
                </div>
            </div>
